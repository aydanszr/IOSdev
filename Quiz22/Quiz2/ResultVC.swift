...
class ResultVC: UIViewController {
    ...
    func showRating() {
        ...
        let s = sc * 100 / tc
        if s < 10 {
            rating = "we are not friends"
            color = UIColor.blue
        } else if s < 40 {
            rating = "we are old friends"
            color = UIColor.purple
        } else if s < 60 {
            rating = "good job, my dear friend"
            color = UIColor.yellow
        } else if s < 80 {
            rating = "a few steps to be my bff"
    ...
    func setupViews() {
        ...
        lblRating.widthAnchor.constraint(equalToConstant: 300).isActive=true
